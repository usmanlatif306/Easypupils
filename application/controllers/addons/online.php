...
class Online extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('addons/Online_model', 'online_model');
    ...
    public function index()
    {
        ...
        $page_data['folder_name'] = 'online';
        $page_data['page_title'] = 'your_online';
        $page_data['navigate'] = 'online';
    ...
    public function create()
    {
        ...
        $page_data['folder_name'] = 'online';
        $page_data['page_title'] = 'arrange_a_online';
    ...
    public function store()
    {
        ...
        $response = $this->online_model->store();
        echo $response;
    }
    ...
    public function update()
    {
        ...
        $response = $this->online_model->update();
        echo $response;
    }
    ...
    public function delete($id)
    {
        ...
        $response = $this->online_model->delete($id);
        echo $response;
    }
    ...
    public function sendmail()
    {
        ...
        $response = $this->online_model->sendmail();
        echo $response;
    }
    ...
    public function start($id)
    {
        ...
        $live_class_details = $this->online_model->get_live_class_by_id($id);
        ...
        if ($live_class_details->num_rows() > 0) {
            ...
            $page_data['live_class_settings'] = $this->online_model->get_live_class_settings($live_class_details['teacher_id']);
            $this->load->view("backend/$user_type/online/meeting", $page_data);
        } else {
            redirect(site_url('addons/online'), 'refresh');
        }
    }
    ...
    public function settings($action = "")
    {
        ...
        $page_data['page_title'] = 'online_settings';
    ...
    public function update_settings()
    {
        ...
        $response = $this->online_model->update_settings();
        $this->session->set_flashdata('success_message', get_phrase('online_settings_updated_successfully'));
        redirect(site_url('addons/online/settings'), 'refresh');
        //echo $response;
    }
