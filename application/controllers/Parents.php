...
class Parents extends CI_Controller
{
	...
	// chat
	public function chat($param1 = '', $param2 = '', $param3 = '')
	{
		if ($param1 == 'create') {
		...
		if ($param1 == 'list') {
			$this->load->view('backend/parent/chat/list');
		}
		...
		if ($param1 == 'filter') {
			...
			$this->load->view('backend/parent/chat/users', $page_data);
		}
	...
	public function noticeboard($param1 = "", $param2 = "", $param3 = "")
	{
		...
		if ($param1 == 'list') {
			$this->load->view('backend/parent/noticeboard/list');
		}
	...
	public function class_wise_subject($class_id)
	{
		...
		$this->load->view('backend/parent/mark/dropdown', $page_data);
	}
