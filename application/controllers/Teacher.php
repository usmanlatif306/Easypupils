...
class Teacher extends CI_Controller
{
	...
	public function chat($param1 = '', $param2 = '', $param3 = '')
	{
		...
		if ($param1 == 'filter') {
			...
			$this->load->view('backend/teacher/chat/users', $page_data);
		}
	...
	{
		// $this->email_model->send_mail_using_smtp('Test Message', 'Test', 'student@demo.com');
	...
	public function noticeboard($param1 = "", $param2 = "", $param3 = "")
	{
		...
		if ($param1 == 'list') {
			$this->load->view('backend/teacher/noticeboard/list');
		}
