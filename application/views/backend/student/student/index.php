        ...
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">
                    ...
                    <a href="<?php echo route('student/create'); ?>" class="btn btn-icon btn-success btn-rounded mb-1 mt-3 alignToTitle float-right"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('add_new_student'); ?></a>
                </h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card ">
                <div class="row mt-3">
                    ...
                    <div class="col-md-2">
                        <button class="btn btn-block btn-secondary" onclick="filter_student()"><?php echo get_phrase('submit'); ?></button>
                    </div>
                </div>
