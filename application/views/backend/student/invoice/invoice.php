...
<div class="row">
  <div class="col-12">
    <div class="page-title-box">
      <h4 class="page-title">
        <i class="mdi mdi-grease-pencil title_icon"></i> <?php echo get_phrase('invoice'); ?><a href="<?php echo site_url('student/dashboard'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle mx-1">Dashboard</a>
      </h4>
    </div>
  </div>
</div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-sm-4 offset-sm-2">
            ...
            <?php else : ?>
              <span class="badge badge-danger float-right"><?php echo get_phrase('unpaid'); ?></span></p>
            <?php endif; ?>
            </div>
          </div><!-- end col -->
        </div>
              ...
              <table class="table mt-4">
                <thead>
                  <tr>
                    ...
                    <th class="text-right"><?php echo get_phrase('due_amount'); ?></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td class="text-right"><?php echo currency($invoice_details['total_amount'] - $invoice_details['paid_amount']); ?></td>
                  </tr>
                </tbody>
              </table>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="float-right mt-3 mt-sm-0">
              <p><b><?php echo get_phrase('total_amount'); ?> :&nbsp;</b> <span class="float-right"><?php echo currency($invoice_details['total_amount']); ?></span></p>
              <p><b><?php echo get_phrase('due_amount'); ?> : </b> <span class="float-right"><?php echo currency($invoice_details['total_amount'] - $invoice_details['paid_amount']); ?></span></p>
