		...
		<div class="card">
			<div class="card-body">
				<h4 class="page-title">
					...
					<button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="rightModal('<?php echo site_url('modal/popup/routine/create'); ?>', '<?php echo get_phrase('create_routine'); ?>')"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('add_class_routine'); ?></button>
				</h4>
			</div> <!-- end card body-->
		</div> <!-- end card -->
	</div><!-- end col-->
