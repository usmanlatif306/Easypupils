              ...
              <div class="wrapper-image-preview" style="margin-left: -6px;">
                <div class="box" style="width: 250px;">
                  ...
                  <div class="upload-options">
                    <label for="header_logo" class="btn"> <i class="mdi mdi-camera"></i> <?php echo get_phrase('upload_header_logo'); ?> </label>
            ...
            <div class="col-md-9 custom-file-upload">
              <div class="wrapper-image-preview" style="margin-left: -6px;">
                <div class="box" style="width: 250px;">
                  ...
                  <div class="upload-options">
                    <label for="footer_logo" class="btn"> <i class="mdi mdi-camera"></i> <?php echo get_phrase('upload_footer_logo'); ?> </label>
