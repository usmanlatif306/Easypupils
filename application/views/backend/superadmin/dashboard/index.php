          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-4 p-0 mb-2 text-center">
                ...
                <a href="<?php echo site_url('superadmin/routine'); ?>" class="d-block">Class Routine</a>
              </div>
              <div class="col-4 p-0 mb-2 text-center">
                <i class="mdi mdi-book-variant title_icon"></i>
                <a href="<?php echo site_url('superadmin/syllabus'); ?>" class="d-block">Syllabus</a>
              </div>
              <div class="col-4 p-0 mb-2 text-center">
                <i class="mdi mdi-google-earth title_icon"></i>
                <a href="<?php echo site_url('superadmin/attendance'); ?>" class="d-block">Attendance</a>
              </div>
              <div class="col-4 p-0 mb-2 text-center">
                <i class="mdi mdi-book-multiple title_icon"></i>
                <a href="<?php echo site_url('superadmin/subject'); ?>" class="d-block">Subject</a>
              </div>
              <div class="col-4 p-0 mb-2 text-center">
              ...
              <div class="col-4 p-0 mb-2 text-center">
                ...
                <a href="<?php echo site_url('superadmin/mark'); ?>" class="d-block">Exam</a>
              </div>
              <div class="col-4 p-0 mb-2 text-center">
                <i class="mdi mdi-timetable title_icon"></i>
                <a href="<?php echo site_url('superadmin/noticeboard'); ?>" class="d-block">Notice Board</a>
              </div>

              <div class="col-4 p-0 mb-2 text-center">
                <i class="mdi mdi-calendar title_icon"></i>
                <a href="<?php echo site_url('superadmin/event_calendar'); ?>" class="d-block">Event Calendar</a>
              </div>
              <div class="col-4 p-0 mb-2 text-center">
                <i class="mdi mdi-clipboard title_icon"></i>
                <a href="<?php echo site_url('superadmin/invoice'); ?>" class="d-block">Accounting</a>
              </div>
              <div class="col-4 p-0 mb-2 text-center">
                <i class="mdi dripicons-user title_icon"></i>
                <a href="<?php echo site_url('superadmin/student'); ?>" class="d-block">Users</a>
              </div>
              <div class="col-4 p-0 mb-2 text-center">
                <i class="mdi mdi-library title_icon"></i>
                <a href="<?php echo site_url('superadmin/book'); ?>" class="d-block">Library</a>
              </div>
              <div class="col-4 p-0 mb-2 text-center">
                <i class="mdi mdi-view-dashboard title_icon"></i>
                <a href="<?php echo site_url('superadmin/dashboard'); ?>" class="d-block">Dashboard</a>
              </div>
              ...
              <div class="col-4 p-0 mb-2 text-center" style="position: relative;">
                ...
                <a href="<?php echo site_url('superadmin/chat'); ?>" class="d-block">Chat</a>
