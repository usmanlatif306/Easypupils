  ...
  <ul class="metismenu side-nav side-nav-light">
    ...
    ?><li class="side-nav-item"><?php
          ...
          <ul class="side-nav-second-level" aria-expanded="false">
            ...
            <?php $menus = $this->db->get_where('menus', array('parent' => $main_menu['id'], 'status' => 1, $this->session->userdata('user_type') . '_access' => 1))->result_array();
                ...
                <!-- This is showing library menu -->
                <!-- <i class="dripicons-user"></i> -->

                <!-- <a href="javascript: void(0);" class="ml-0 ml-lg-5">
                 <i class="dripicons-user"></i>
                <span class="ml-2"><?php echo get_phrase($menu['displayed_name']); ?></
            </a> -->

                <a href="javascript: void(0);" class="ml-0 ml-lg-5" aria-expanded="false"><?php echo get_phrase($menu['displayed_name']); ?>
                  <span class="menu-arrow"></span>
                </a>
    ...
    <?php } else { ?>
      <li>
        ...
        <a href="<?php if ($menu['route_name'] === 'invoice') {
                                        echo 'javascript: void(0);';
                                      } else {
                                        echo site_url($route);
                                      } ?>" class="nav-secd-layer <?php if ($menu['displayed_name'] === 'website_settings' || $menu['displayed_name'] === 'about') echo 'd-none'; ?>">
          <!-- <i class="dripicons-user"></i> -->

          <i class="<?php echo $menu['icon']; ?>"></i>
          <span class="ml-2"><?php echo get_phrase($menu['displayed_name']); ?></span>
        </a>
