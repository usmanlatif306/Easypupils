                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <!-- <div class="col-4 p-0 mb-2 text-center">
                                ...
                                <a href="#" class="d-block">My File</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-book-open title_icon "></i>
                                <a href="#" class="d-block">Work Book</a>
                            </div> -->
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-note-text title_icon"></i>
                                <a href="<?php echo site_url('addons/assignment/student_assignment/published'); ?>" class="d-block">Assignments</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-briefcase-check title_icon"></i>
                                <a href="<?php echo site_url('teacher/routine'); ?>" class="d-block">Class Routine</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-book-variant title_icon"></i>
                                <a href="<?php echo site_url('teacher/syllabus'); ?>" class="d-block">Syllabus</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-google-earth title_icon"></i>
                                <a href="<?php echo site_url('teacher/attendance'); ?>" class="d-block">Attendance</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-book-multiple title_icon"></i>
                                <a href="<?php echo site_url('teacher/subject'); ?>" class="d-block">Subject</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                            ...
                            <div class="col-4 p-0 mb-2 text-center">
                                ...
                                <a href="<?php echo site_url('teacher/mark'); ?>" class="d-block">Exam</a>
                            </div>
                            <!-- <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-timetable title_icon"></i>
                                <a href="#" class="d-block">Notice Board</a>
                            </div> -->
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-calendar title_icon"></i>
                                <a href="<?php echo site_url('teacher/event_calendar'); ?>" class="d-block">Event Calendar</a>
                            </div>
                            <!-- <div class="col-4 p-0 mb-2 text-center">
                            ...
                            <div class="col-4 p-0 mb-2 text-center">
                                ...
                                <a href="<?php echo site_url('teacher/student'); ?>" class="d-block">Users</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                            ...
                            <div class="col-4 p-0 mb-2 text-center">
                                ...
                                <a href="<?php echo site_url('teacher/book'); ?>" class="d-block">Library</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-view-dashboard title_icon"></i>
                                <a href="<?php echo site_url('teacher/dashboard'); ?>" class="d-block">Dashboard</a>
                            </div>
                            <?php
                            ...
                            <div class="col-4 p-0 mb-2 text-center" style="position: relative;">
                                ...
                                <a href="<?php echo site_url('teacher/chat'); ?>" class="d-block">Chat</a>
                    ...
                    <div class="col-lg-6">
                        <div class="card widget-flat" id="student">
                            <div class="card-body">
                                ...
                                <h5 class="text-muted font-weight-normal mt-0" title="Number of Student"> <i class="mdi mdi-account-group title_icon"></i> <?php echo get_phrase('students'); ?> <a href="<?php echo route('student'); ?>" style="color: #6c757d;" id="student_list"><i class="mdi mdi-export"></i></a></h5>
                                <h3 class="mt-3 mb-3">
                                    <?php
                    ...
                    <div class="col-lg-6">
                        <div class="card widget-flat" id="teacher">
                            <div class="card-body">
                                ...
                                <h5 class="text-muted font-weight-normal mt-0" title="Number of Teacher"> <i class="mdi mdi-account-group title_icon"></i><?php echo get_phrase('teacher'); ?> <a href="<?php echo route('teacher'); ?>" style="color: #6c757d;" id="teacher_list"><i class="mdi mdi-export"></i></a></h5>
                                <h3 class="mt-3 mb-3">
                                    <?php
