...
<form method="POST" class="d-block ajaxForm responsive_media_query" action="<?php echo site_url('addons/biometric_attendance/store_excel'); ?>" enctype="multipart/form-data">
    <div class="form-row">
