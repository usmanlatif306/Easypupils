		...
		<tr>
			...
			<td class="text-center">
				<div class="btn-group">
					...
					<button type="button" class="btn btn-primary dropdown-btn dropdown-toggle arrow-none card-drop text-white" data-bs-toggle="dropdown" aria-expanded="false"><i class="mdi mdi-dots-vertical"></i></button>
					<div class="dropdown-menu dropdown-menu-right">
						<!-- item-->
						<a href="javascript:void(0);" class="dropdown-item" onclick="rightModal('<?php echo site_url('modal/popup/live_class/mail/'.$live_class['id'])?>', '<?php echo get_phrase('send_mail_to_class_student'); ?>');"><?php echo get_phrase('notify_student'); ?></a>
						<!-- item-->
