                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 p-0 mb-2 text-center">
                                ...
                                <a href="<?php echo site_url('parents/routine'); ?>" class="d-block">Class Routine</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-book-variant title_icon"></i>
                                <a href="<?php echo site_url('parents/syllabus'); ?>" class="d-block">Syllabus</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-google-earth title_icon"></i>
                                <a href="<?php echo site_url('parents/attendance'); ?>" class="d-block">Attendance</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-book-multiple title_icon"></i>
                                <a href="<?php echo site_url('parents/subject'); ?>" class="d-block">Subject</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                            ...
                            <div class="col-4 p-0 mb-2 text-center">
                                ...
                                <a href="<?php echo site_url('parents/mark'); ?>" class="d-block">Exam</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-timetable title_icon"></i>
                                <a href="<?php echo site_url('parents/noticeboard'); ?>" class="d-block">Notice Board</a>
                            </div>

                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-calendar title_icon"></i>
                                <a href="<?php echo site_url('parents/event_calendar'); ?>" class="d-block">Event Calendar</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-clipboard title_icon"></i>
                                <a href="<?php echo site_url('parents/invoice'); ?>" class="d-block">Accounting</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi dripicons-user title_icon"></i>
                                <a href="<?php echo site_url('parents/teacher'); ?>" class="d-block">Resources</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                            ...
                            <div class="col-4 p-0 mb-2 text-center">
                                ...
                                <a href="<?php echo site_url('parents/book'); ?>" class="d-block">Library</a>
                            </div>
                            <div class="col-4 p-0 mb-2 text-center">
                                <i class="mdi mdi-view-dashboard title_icon"></i>
                                <a href="<?php echo site_url('parents/dashboard'); ?>" class="d-block">Dashboard</a>
                            </div>
                            <?php
                            ...
                            <div class="col-4 p-0 mb-2 text-center" style="position: relative;">
                                ...
                                <a href="<?php echo site_url('parents/chat'); ?>" class="d-block">Chat</a>
                    ...
                    <div class="col-lg-6">
                        <div class="card widget-flat" id="parent">
                            <div class="card-body">
                                ...
                                <h5 class="text-muted font-weight-normal mt-0" title="Assignments"> <i class="mdi mdi-account-group title_icon"></i> <?php echo get_phrase('Assignments'); ?> <a href="<?php echo site_url('addons/assignment/student_assignment/published'); ?>" style="color: #6c757d;" id="parent_list"><i class="mdi mdi-export"></i></a></h5>
                                <h3 class="mt-3 mb-3">
                                    <?php
