		...
		<div class="card">
			<div class="card-body">
				<h4 class="page-title">
					...
					<a href="<?= site_url('addons/assignment/student_assignment/expired'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"> <i class="mdi mdi-arrow-left"></i> <?php echo get_phrase('back'); ?></a>
				</h4>
			</div> <!-- end card body-->
		</div> <!-- end card -->
	</div><!-- end col-->
