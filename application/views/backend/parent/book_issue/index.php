    ...
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title"> <i class="mdi mdi-library title_icon"></i> <?php echo get_phrase('books_issue'); ?>
                ...
                <button type="button" class="btn btn-icon btn-success btn-rounded alignToTitle" onclick="rightModal('<?php echo site_url('modal/popup/book_issue/create'); ?>', '<?php echo get_phrase('issue_book'); ?>')"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('issue_book'); ?></button>
            </h4>
        </div>
    </div>
</div>
